...
if __name__ == "__main__":
    ...
    # Config
    # base directory to point to the parent directory of 'utils'
    base_dir = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))

    # folder_path to point to the 'data/eight_k_htm' folder
    folder_path = os.path.join(base_dir, 'data', 'eight_k_htm')

    # Update paths for other data files in the 'data' folder
    ff_daily_factors_path = os.path.join(base_dir, 'data', 'ff_daily_factors.csv')
    ff_monthly_factors_path = os.path.join(base_dir, 'data', 'ff_monthly_factors.csv')
    sp500_data_path = os.path.join(base_dir, 'data', 'sp500_data.csv')
